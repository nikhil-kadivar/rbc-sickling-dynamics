...
extract_frames.py → creates Task{ID}_{NAME}/imagesTs/…
nnunet_infer.py → runs nnUNetv2_predict on imagesTs/
sicklecell_count_and_visualize.py → counts cells, makes plots & a montage video
---
